// Práctica — Los 4 pilares de la POO + getters y setters - NO ME DEJA ESCRIBIR EN EL README ENTONCES POR ESO ESCRIBO ACÁ
// Configuración inicial
// Antes de resolver los ejercicios, armá un proyecto de TypeScript desde cero (no reutilices uno viejo): inicializá un proyecto de Node, instalá TypeScript como dependencia de desarrollo, y configurá y creá el tsconfig.json.

// Después, creá un archivo por ejercicio: ej1.ts, ej2.ts, ej3.ts, ej4.ts, ej5.ts.
